...
function App() {
  ...
  useEffect(()=>{
    const reload = async() =>{
      try{
         const response = await axios.post("https://football-quiz-backend-main-h9v8y3si6-umang-tibrewal.vercel.app/user/userInfo",{ headers: { authorization:localStorage.getItem('token') }
       })
